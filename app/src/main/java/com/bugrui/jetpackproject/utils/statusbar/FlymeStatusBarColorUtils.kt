 ...
 * 魅族手机状态栏字体颜色
 */
object FlymeStatusBarColorUtils {
    ...
    private fun changeMeizuFlag(winParams: LayoutParams, flagName: String, on: Boolean): Boolean {
        try {
    ...
    init {
        ...
        try {
            mStatusBarColorFiled =
                LayoutParams::class.java.getField("statusBarColor")
        } catch (e: NoSuchFieldException) {
            e.printStackTrace()
        }
        try {
